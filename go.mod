module github.com/slok/brigadeterm

require (
	cloud.google.com/go v0.21.0 // indirect
	github.com/Azure/brigade v0.20.0
	...
	github.com/gophercloud/gophercloud v0.0.0-20180418172423-8170fdb8819b // indirect
	...
	k8s.io/api v0.0.0-20180828232432-12444147eb11 // indirect
	k8s.io/apimachinery v0.0.0-20180619225948-e386b2658ed2 // indirect
